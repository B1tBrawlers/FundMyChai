  ...
  return (
    <>
      ...
      <footer className="text-center py-6 text-gray-500 text-sm">
        <p className="mb-2">SimpleFund - A minimal ETH crowdfunding platform</p>
        <Link href="/debug" className="text-purple-600 hover:text-purple-800 text-xs">Debug Routes</Link>
      </footer>
    </>
  );
}
